...
namespace Nop.Plugin.Misc.Sms77
{
    ...
    /// </summary>
    public static class Sms77Defaults
    {
        /// <summary>
        /// Gets a plugin system name
        /// </summary>
        public static string SystemName => "Misc.Sms77";
        ...
        /// <summary>
        /// Gets a user agent used to request Sms77 services
        /// </summary>
        ...
        /// </summary>
        public static CacheKey SyncKeyCache => new CacheKey("PLUGINS_MISC_SMS77_SYNCINFO");
