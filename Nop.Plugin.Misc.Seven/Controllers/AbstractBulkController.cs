...
using Nop.Plugin.Misc.Seven.Services;
    ...
    public abstract class AbstractBulkController<T, TR> : AbstractBaseController
        ...
        public IActionResult Bulk() {
            ...
            if (string.IsNullOrEmpty(settings.ApiKey)) {
                return Redirect($"{SevenPlugin.ConfigurePath}?autofocus=ApiKey");
            }
            ...
            var model = new T {
                ...
                Text = LocalizationService.GetResource("Plugins.Misc.Seven.Message.Text.Placeholder")
            };
